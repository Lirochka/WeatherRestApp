...
import com.example.weatherrestapp.databinding.FragmentWeatherBinding
import com.example.weatherrestapp.repository.WeatherRepositoryImpl.Companion.WEATHER_TYPE_CLEAR
import com.example.weatherrestapp.repository.WeatherRepositoryImpl.Companion.WEATHER_TYPE_CLOUDS
import com.example.weatherrestapp.repository.WeatherRepositoryImpl.Companion.WEATHER_TYPE_RAIN
import com.example.weatherrestapp.repository.WeatherRepositoryImpl.Companion.WEATHER_TYPE_SNOW
...
class WeatherFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mainViewModel.currentWeatherResult.observe(
